...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("campaign_type", campaigntype, nullable=False, server_default="general"),
        ...
        sa.Column("visibility_mode", visibilitymode, nullable=False, server_default="full_name"),
    ...
    op.create_table(
        ...
        sa.Column("paid_via", paidvia, nullable=True),
