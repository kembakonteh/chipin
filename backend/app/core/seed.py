...
_TEMPLATES = [
    ...
    {
        "name": "Monthly Church Offering",
        "campaign_type": CampaignType.charity,
        "emoji": "⛪",
        "description_template": "Monthly offering for {church_name}.",
        "default_amount_per_person": Decimal("20.00"),
        "default_visibility_mode": VisibilityMode.first_name_only,
        "default_anonymous": False,
        "whatsapp_share_text_template": "Please chip in for this month's offering at {church_name}. {url}",
        "sort_order": 2,
        "is_active": True,
    },
    {
