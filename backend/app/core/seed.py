...
_TEMPLATES = [
    ...
    {
        "name": "Monthly Religious Collection",
        "campaign_type": CampaignType.charity,
        "emoji": "🙏",
        "description_template": "Monthly {month} collection for {place_of_worship}.",
        "default_amount_per_person": Decimal("20.00"),
        "default_visibility_mode": VisibilityMode.first_name_only,
        "default_anonymous": False,
        "whatsapp_share_text_template": "Please chip in for this month's collection at {place_of_worship}. {url}",
        "sort_order": 2,
        "is_active": True,
    },
    {
